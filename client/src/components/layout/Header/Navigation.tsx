...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  console.log("featuredBrands " , featuredBrands)

  // Enhanced navigation with conditional brand section
...
// Trending Products Dropdown Component
    ...
    <div className="grid grid-cols-4 gap-4">
      {products.slice(0, 4).map((product) => (
        <Link
          ...
          className="group p-4 rounded-lg hover:bg-gray-50 transition-colors border border-gray-100"
        >
          {/* Product Image */}
      ...
      <div className="grid grid-cols-3 gap-4 text-center">
        ...
        <div className="text-center">
          <div className="text-lg font-bold text-gray-900">
            {Math.max(...products.map(p => p.salesCount)).toLocaleString()}
          </div>
