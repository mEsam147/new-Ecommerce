...
const HeroSection = () => { // Renamed from Header to HeroSection
  return (
    <section className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden relative"> {/* Removed z-30 entirely */}
...
export default HeroSection; // Updated export name
