...
export default function ShopPage() {
  ...
  }, [filters.featured, filters.category]);
                ...
                <div className="flex-1 overflow-y-auto">
                  <ShopFilters
                    ...
                    onFilterChange={(newFilters) => {
                      setFilters(newFilters);
                      // Auto-close dialog when filters are applied on mobile
                      if (newFilters.category || newFilters.search || newFilters.colors?.length || newFilters.sizes?.length || newFilters.featured) {
                        setIsMobileFiltersOpen(false);
                      }
                    }}
                    isFiltering={isFiltering}
            ...
            {!isLoading && products.length === 0 && (
              <div className="text-center py-12 border rounded-lg bg-gray-50">
                <div className="max-w-md mx-auto">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    {filters.featured ? 'No featured products found' : 'No products found'}
                  </h3>
                  <p className="text-gray-600 mb-4 text-sm">
                    {hasActiveFilters
                      ? "Try adjusting your filters or search terms."
