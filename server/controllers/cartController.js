...
export const addToCart = asyncHandler(async (req, res) => {
  ...
  const requestedQuantity =
    existingItemIndex > -1 ? cart.items[existingItemIndex].quantity + quantity : quantity
  ...
  await cart.save()
  await cart.populate('items.product', 'title images price variants inventory isActive')
